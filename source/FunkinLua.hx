...
class FunkinLua {
	...
	public function new(script:String) {
		...
		Lua_helper.add_callback(lua, "addShader", function(object:String, waveSpeed:Float = 2,waveFrq:Float = 5,waveAmp:Float = 0.1) {
			PlayState.instance.addShader(getObjectDirectly(object), waveSpeed,waveFrq,waveAmp);
		});
